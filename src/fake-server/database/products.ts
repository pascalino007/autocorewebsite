...
import { shops } from '~/fake-server/database/shops';
...
function makeProducts(defs: IProductDef[]): IProduct[] {
    return defs.map((def) => {
        ...
        if (def.shop) {
            shop = shops.find((x) => x.slug === def.shop) || shop;
        } else if (brand.shopId) {
            // Fallback to shop based on brand.shopId
            shop = shops.find((x) => x.id === brand.shopId) || shop;
        }
...
const productsDef: IProductDef[] = [
    ...
    {
        name: 'RidgeLine Moto Brake Kit RBK-220',
        slug: 'ridgeline-moto-brake-kit-rbk-220',
        sku: 'RBK-220-M',
        price: 199,
        images: [
            '/images/products/product-2-1.jpg',
        ...
        reviews: 12,
        availability: 'in-stock',
        categories: ['moto-brakes'],
        attributes: {
            Color: 'Steel',
        },
    },
    {
        name: 'VoltEdge Moto LED Headlight',
        slug: 'voltedge-moto-led-headlight',
        sku: 'VED-510-L',
        price: 89,
        images: [
            '/images/products/product-3-1.jpg',
        ...
        reviews: 31,
        availability: 'in-stock',
        categories: ['moto-lighting'],
        attributes: {
            Color: 'White',
        },
    },
    {
        name: 'TrailGuard Chain & Sprocket Set',
        slug: 'trailguard-chain-sprocket-set',
        sku: 'TGS-440-C',
        price: 149,
        images: [
            '/images/products/product-5-1.jpg',
        ...
        reviews: 18,
        availability: 'in-stock',
        categories: ['moto-engine'],
        attributes: {
            Color: 'Graphite',
        },
    },
    {
        name: 'Gripline Touring Tire 120/70',
        slug: 'gripline-touring-tire-120-70',
        sku: 'GLT-12070',
        price: 129,
        images: [
            '/images/products/product-14-1.jpg',
        ...
        reviews: 9,
        availability: 'in-stock',
        categories: ['moto-tires'],
        attributes: {
            Color: 'Black',
        },
    },
    {
        name: 'StormRider Battery 12V',
        slug: 'stormrider-battery-12v',
        sku: 'SRB-12V',
        price: 75,
        images: [
            '/images/products/product-24-1.jpg',
        ...
        reviews: 14,
        availability: 'in-stock',
        categories: ['moto-electrical'],
        attributes: {
            Color: 'Black',
        },
    },
    {
        name: 'Apex Pro Helmet Matte',
        slug: 'apex-pro-helmet-matte',
        sku: 'APH-900-M',
        price: 239,
        images: [
            '/images/products/product-16-1.jpg',
        ...
        reviews: 27,
        availability: 'in-stock',
        categories: ['moto-safety', 'moto-accessories'],
        attributes: {
            Color: 'Matte Black',
        },
    },
