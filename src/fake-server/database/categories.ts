...
const shopCategoriesDef: ICategoryDef[] = [
    ...
    },
    {
        ...
        items: 120,
        children: [
            { name: 'Moto Brakes', slug: 'moto-brakes' },
            { name: 'Moto Engine', slug: 'moto-engine' },
            { name: 'Moto Electrical', slug: 'moto-electrical' },
            { name: 'Moto Tires', slug: 'moto-tires' },
            { name: 'Moto Lighting', slug: 'moto-lighting' },
            { name: 'Moto Accessories', slug: 'moto-accessories' },
            { name: 'Helmets & Safety', slug: 'moto-safety' },
            { name: 'Maintenance', slug: 'moto-maintenance' },
        ],
    },
    {
