        ...
        <table className="cart-table__table">
            <thead className="cart-table__head">
                <tr className="cart-table__row">
                    ...
                    <th className="cart-table__column cart-table__column--delivery">
                        F.Livraison
                    </th>
            ...
            <tbody className="cart-table__body">
                {items.map((item) => (
                    <tr key={item.id} className="cart-table__row">
                        ...
                        <td className="cart-table__column cart-table__column--delivery" data-title="F.Livraison">
                            <CurrencyFormat value={(item.deliveryFee || 0) * item.quantity} />
                        </td>
