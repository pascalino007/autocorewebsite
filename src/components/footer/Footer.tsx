                ...
                <div className="container">
                    <div className="site-footer__bottom-row">
                        <div className="site-footer__copyright">
                            {`© ${new Date().getFullYear()} Akodessewa.com — `}
                            {'Designed & Maintained by '}
                            <AppLink href="https://imaginovecybertech.com" target="_blank" rel="noreferrer">
                                Imaginov Cyber Tech
                            </AppLink>
                        </div>
                        <div className="site-footer__app-stores">
                            <AppLink href="https://apps.apple.com" target="_blank" rel="noreferrer" className="site-footer__store-link">
                                <AppImage src="/images/app-store-badge.svg" alt="Download on the App Store" />
                            </AppLink>
                            <AppLink href="https://play.google.com/store" target="_blank" rel="noreferrer" className="site-footer__store-link">
                                <AppImage src="/images/play-store-badge.svg" alt="Get it on Google Play" />
                            </AppLink>
                        </div>
