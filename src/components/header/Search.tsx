...
import VehicleTypeModal from '~/components/header/VehicleTypeModal';
...
export function Search(props: Props) {
    ...
    const handleFormSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (query.trim()) {
            // Redirect to search results page using Next.js router
            const searchUrl = `/search?query=${encodeURIComponent(query.trim())}`;
            ...
            <form className="search__body" onSubmit={handleFormSubmit}>
                ...
                >
                    ...
                    <span className="search__button-title">
                        {mode === 'moto' ? 'Select Bike' : intl.formatMessage({ id: 'BUTTON_SEARCH_SELECT_VEHICLE_DESKTOP' })}
                    </span>
                </button>
